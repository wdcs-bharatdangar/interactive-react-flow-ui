...
```bash
git remote add encore encore://interactive-react-flow-ui-gt22
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/interactive-react-flow-ui-gt22/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/interactive-react-flow-ui-gt22/settings/integrations/github)
